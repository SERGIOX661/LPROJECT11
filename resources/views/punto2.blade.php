...
<head>
    <meta charset="UTF-8">
    <title>Casino UTA - Punto 2</title>
...
<div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-4xl border">
    <!-- Título -->
    <div class="mb-4">
        <h2 class="text-2xl font-bold text-gray-800">CASINO UTA</h2>
    ...
    <div class="flex flex-col md:flex-row gap-6">
        ...
        <div class="w-full md:w-1/2">
            <img src="{{ asset('punto2.jpg') }}" alt="Casino UTA" class="rounded-lg shadow">
        </div>
...
<form action="{{ route('votar') }}" method="POST" class="flex justify-between">
    @csrf
    <input type="hidden" name="local_id" value="2">
...
<div class="mt-6">
    ...
    <div id="comentarios-section" class="hidden">
        ...
        @php
            $comentarios = \App\Models\Comentario::where('punto', 'punto2')->latest()->take(50)->get();
        @endphp
        ...
        @auth
            ...
            <form action="{{ route('comentarios.store') }}" method="POST" class="flex gap-2">
                @csrf
                <input type="hidden" name="punto" value="punto2">
