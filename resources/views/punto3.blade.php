...
<head>
    <meta charset="UTF-8">
    <title>Foodtruck 2 UTA - Punto 3</title>
...
<div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-4xl border">
    <!-- Título -->
    <div class="mb-4">
        <h2 class="text-2xl font-bold text-gray-800">FOODTRUCK 2 UTA</h2>
    ...
    <div class="flex flex-col md:flex-row gap-6">
        ...
        <div class="w-full md:w-1/2">
            <img src="{{ asset('punto3.png') }}" alt="Casino UTA" class="rounded-lg shadow">
        </div>
...
<form action="{{ route('votar') }}" method="POST" class="flex justify-between">
    @csrf
    <input type="hidden" name="local_id" value="3">
    ...
    <div id="comentarios-section" class="hidden">
        ...
        @auth
            ...
            <form action="{{ route('comentarios.store') }}" method="POST" class="flex gap-2">
                @csrf
                <input type="hidden" name="punto" value="punto3">
